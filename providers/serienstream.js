...
function dbg() {
  ...
  if (DEBUG) (_console = console).warn.apply(_console, ['[Serienstream]'].concat(args));
}
...
function fixUrl(href) {
  ...
  href = href.replace(/^https?:\/\/s\.to/i, BASE).replace(/^https?:\/\/serienstream\.to/i, BASE).replace(/^https?:\/\/www\.serienstream\.to/i, BASE);
...
function _getTmdbTitles() {
  _getTmdbTitles = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(tmdbId) {
    var _yield$Promise$all, _yield$Promise$all2, de, en, titles, _t;
    return _regenerator().w(function (_context3) {
      while (1) switch (_context3.p = _context3.n) {
        case 0:
          _context3.p = 0;
          _context3.n = 1;
          return Promise.all([fetchJson("https://api.themoviedb.org/3/tv/".concat(tmdbId, "?api_key=").concat(TMDB_API_KEY, "&language=de-DE")), fetchJson("https://api.themoviedb.org/3/tv/".concat(tmdbId, "?api_key=").concat(TMDB_API_KEY, "&language=en-US"))]);
        case 1:
          ...
          titles = new Set();
          [de.name, de.original_name, en.name, en.original_name].filter(Boolean).forEach(function (t) {
            return titles.add(t);
          });
...
function searchSerienstream(_x4) {
  return _searchSerienstream.apply(this, arguments);
}
function _searchSerienstream() {
  _searchSerienstream = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4(query) {
    var url, html, $, results, _t2;
    return _regenerator().w(function (_context4) {
      while (1) switch (_context4.p = _context4.n) {
        case 0:
          dbg('Searching for:', query);
          // FIX: use /suche?term=...&tab=shows (no change needed here, but selector was wrong)
          url = "".concat(BASE, "/suche?term=").concat(encodeURIComponent(query), "&tab=shows");
          _context4.p = 1;
          _context4.n = 2;
          return fetchText(url, {
            headers: {
              'Referer': "".concat(BASE, "/suche")
            }
          });
        case 2:
          html = _context4.v;
        ...
        case 3:
          _context4.p = 3;
          _t2 = _context4.v;
          dbg('searchSerienstream fetch error:', _t2.message);
          return _context4.a(2, []);
        case 4:
          $ = cheerio.load(html);
          results = []; // FIX: Real selector confirmed from live HTML inspection.
          ...
          $('div.seriesListContainer ul li a').each(function (_, el) {
            ...
            if (href && title) results.push({
              title: title.trim(),
              link: href
            });
          });
          dbg('Search results:', results.map(function (r) {
...
function _findSeriesUrl() {
  _findSeriesUrl = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee6(titles) {
    var _iterator2, _step2, _loop, _ret, _t4;
      ...
      while (1) switch (_context6.p = _context6.n) {
        case 0:
          ...
          _loop = /*#__PURE__*/_regenerator().m(function _callee5() {
            var title, results, target, exact, fuzzy, _t3;
            return _regenerator().w(function (_context5) {
              while (1) switch (_context5.p = _context5.n) {
                case 0:
                  ...
                  _context5.p = 1;
                  _context5.n = 2;
                  return searchSerienstream(title);
                case 2:
                  results = _context5.v;
                  _context5.n = 4;
                  break;
                case 3:
                  _context5.p = 3;
                  _t3 = _context5.v;
                  dbg('findSeriesUrl search error for title:', title, _t3.message);
...
function findEpisodeUrl(_x6, _x7, _x8) {
...
function _findEpisodeUrl() {
  _findEpisodeUrl = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee7(seriesUrl, season, episode) {
    var html, $, seasonLinks, targetSeason, seasonHtml, $$, episodeUrl, _t5, _t6;
    return _regenerator().w(function (_context7) {
      while (1) switch (_context7.p = _context7.n) {
        ...
        case 3:
          _context7.p = 3;
          _t5 = _context7.v;
          dbg('findEpisodeUrl: fetch series page error:', _t5.message);
          return _context7.a(2, null);
        case 4:
          $ = cheerio.load(html);
          seasonLinks = []; // FIX: Real selector confirmed from live HTML.
          ...
          $('div#stream ul li a').each(function (_, el) {
            ...
            if (!isNaN(num)) seasonLinks.push({
              num: num,
              href: href
            });
          });
          dbg('Season links:', seasonLinks.map(function (s) {
            return "Staffel ".concat(s.num, " -> ").concat(s.href);
          }));
        ...
        case 5:
          ...
          if (!targetSeason) {
            dbg("Season ".concat(season, " not found, falling back to first"));
        ...
        case 8:
          _context7.p = 8;
          _t6 = _context7.v;
          dbg('findEpisodeUrl: error fetching season page:', _t6.message);
          return _context7.a(2, null);
        case 9:
          $$ = cheerio.load(seasonHtml);
          episodeUrl = null; // FIX: Real selector confirmed from live HTML.
...
function collectHosterLinks(_x9) {
    ...
    return _regenerator().w(function (_context8) {
      while (1) switch (_context8.p = _context8.n) {
        ...
        case 3:
          _context8.p = 3;
          _t7 = _context8.v;
          dbg('collectHosterLinks fetch error:', _t7.message);
        ...
        case 4:
          ...
          hosters = []; // FIX: Real selector confirmed from live HTML.
    ...
    return _regenerator().w(function (_context9) {
      while (1) switch (_context9.p = _context9.n) {
        ...
        case 2:
          _context9.p = 2;
          _t8 = _context9.v;
          dbg('resolveRedirect error:', _t8.message, 'for', url);
...
function _extractVoe() {
  _extractVoe = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee0(url) {
    var html, m, r, _m, str, decoded, data, source, _m2, _m3, _t9, _t0, _t1, _t10, _t11;
    return _regenerator().w(function (_context0) {
      while (1) switch (_context0.p = _context0.n) {
        ...
        case 2:
          _context0.p = 2;
          _t9 = _context0.v;
          dbg('extractVoe fetch error:', _t9.message);
        ...
        case 5:
          _context0.p = 5;
          _t0 = _context0.v;
          dbg('extractVoe s1 error:', _t0.message);
        case 6:
          _context0.p = 6;
        ...
        case 8:
          _context0.p = 8;
          _t1 = _context0.v;
          dbg('extractVoe s2 error:', _t1.message);
        case 9:
          _context0.p = 9;
        ...
        case 11:
          _context0.p = 11;
          _t10 = _context0.v;
          dbg('extractVoe s3 error:', _t10.message);
        case 12:
          _context0.p = 12;
        ...
        case 14:
          _context0.p = 14;
          _t11 = _context0.v;
          dbg('extractVoe s4 error:', _t11.message);
        case 15:
...
function extractDoodstream(_x10) {
...
function _extractDoodstream() {
  _extractDoodstream = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee1(url) {
    var html, origin, m, passUrl, token, base, rand, finalUrl, _t12;
    return _regenerator().w(function (_context1) {
      while (1) switch (_context1.p = _context1.n) {
        ...
        case 4:
          _context1.p = 4;
          _t12 = _context1.v;
          dbg('extractDoodstream error:', _t12.message);
          return _context1.a(2, null);
      }
    }, _callee1, null, [[0, 4]]);
  }));
    ...
    return _regenerator().w(function (_context10) {
      while (1) switch (_context10.p = _context10.n) {
        ...
        case 3:
          _context10.p = 3;
          _t13 = _context10.v;
          dbg('extractVidoza error:', _t13.message);
          return _context10.a(2, null);
      }
    }, _callee10, null, [[0, 3]]);
  }));
...
function extractStreamtape(_x12) {
    ...
    return _regenerator().w(function (_context11) {
      while (1) switch (_context11.p = _context11.n) {
        ...
        case 3:
          _context11.p = 3;
          _t14 = _context11.v;
          dbg('extractStreamtape error:', _t14.message);
          return _context11.a(2, null);
      }
    }, _callee11, null, [[0, 3]]);
  }));
...
function _extractVidmoly() {
  _extractVidmoly = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee12(url) {
    var html, scripts, re, m, combined, fm, _t15;
    return _regenerator().w(function (_context12) {
      while (1) switch (_context12.p = _context12.n) {
        ...
        case 3:
          _context12.p = 3;
          _t15 = _context12.v;
          dbg('extractVidmoly error:', _t15.message);
          return _context12.a(2, null);
      }
    }, _callee12, null, [[0, 3]]);
  }));
    ...
    return _regenerator().w(function (_context13) {
      while (1) switch (_context13.p = _context13.n) {
        ...
        case 3:
          _context13.p = 3;
          _t16 = _context13.v;
          dbg('extractFilemoon error:', _t16.message);
          return _context13.a(2, null);
      }
    }, _callee13, null, [[0, 3]]);
  }));
...
function resolveHoster(_x15, _x16) {
...
function _getStreams() {
  _getStreams = _asyncToGenerator(function (tmdbId) {
    ...
    return /*#__PURE__*/_regenerator().m(function _callee16() {
      var titles, seriesUrl, episodeUrl, hosters, settled, streams, _t18;
      return _regenerator().w(function (_context16) {
        while (1) switch (_context16.p = _context16.n) {
          ...
          case 5:
            ...
            dbg('series not found on serienstream');
            return _context16.a(2, []);
          case 6:
            _context16.n = 7;
            return findEpisodeUrl(seriesUrl, season, episode);
          case 7:
                  ...
                  while (1) switch (_context15.p = _context15.n) {
                    ...
                    case 2:
                      return _context15.a(2, {
                        name: "Serienstream [".concat(h.hosterName, "]").concat(h.lang ? " (".concat(h.lang, ")") : ''),
                        title: h.hosterName,
                        url: resolved.url,
                    ...
                    case 3:
                      _context15.p = 3;
                      _t17 = _context15.v;
                      dbg('hoster error for', h.hosterName, ':', _t17.message);
                      return _context15.a(2, null);
                  }
                }, _callee15, null, [[0, 3]]);
              }));
          ...
          case 12:
            _context16.p = 12;
            _t18 = _context16.v;
            dbg('getStreams top-level error:', _t18.message);
            return _context16.a(2, []);
        }
      }, _callee16, null, [[1, 12]]);
    })();
